...
from minecraft.networking.connection import Connection, LoginInfo
...
def run_mc_bot():
    while True:
        try:
            ...
            login_info = LoginInfo(username=MC_USERNAME)
            connection = Connection(MC_HOST, MC_PORT, login_info=login_info, allowed_versions=[MC_VERSION])
